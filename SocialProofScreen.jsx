    ...
    <ScreenWrapper>
      <div style={{ padding: '24px 24px 100px' }}>
        ...
        <div style={{ marginBottom: 24 }}>
          <div style={{ color: C.white, fontSize: 24, fontWeight: 700, marginBottom: 6 }}>Your Daily Routine</div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
          {ROWS.map((row, i) => (
            <div key={i} style={{
              ...
              <div style={{ flex: 1 }}>
                <div style={{ color: C.white, fontSize: 14, fontWeight: 600 }}>{row.label}</div>
