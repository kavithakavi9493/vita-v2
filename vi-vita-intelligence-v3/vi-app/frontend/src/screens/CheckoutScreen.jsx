    ...
    <ScreenWrapper>
      <div style={{ padding: '24px 24px 120px' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 20 }}>
          <div>
            <div style={{ color: C.text, fontSize: 22, fontWeight: 700 }}>Checkout</div>
        ...
        <div style={{ background: C.goldBg, border: `1px solid ${C.gold}`, borderRadius: 16, padding: 16, marginBottom: 18 }}>
          <div onClick={() => setOpen(!open)} style={{ display: 'flex', justifyContent: 'space-between', cursor: 'pointer' }}>
            <div>
              <div style={{ color: C.text, fontSize: 15, fontWeight: 600 }}>Order Summary</div>
            ...
            <div style={{ marginTop: 12, borderTop: `1px solid ${C.goldBorder}`, paddingTop: 12 }}>
              {[
                ...
                <div key={item.l} style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 6 }}>
                  ...
                  <span style={{ color: item.vc || C.text, fontSize: 13 }}>{item.v}</span>
                </div>
              ))}
        ...
        <div style={{ marginBottom: 18 }}>
          <div style={{ display: 'flex', gap: 4, alignItems: 'center', marginBottom: 12 }}>
            ...
            <span style={{ color: C.text, fontSize: 16, fontWeight: 700 }}>Delivery Address</span>
          </div>
          ...
          <div>
            ...
            <input
              ...
              style={{ width: '100%', height: 50, background: C.card, border: `1px solid ${C.border}`, borderRadius: 12, color: C.text, fontSize: 14, padding: '0 16px', marginBottom: 12 }}
            />
          </div>
        ...
        <div style={{ background: C.card, border: `1px solid ${C.gold}`, borderRadius: 16, padding: 16, marginBottom: 16 }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 12 }}>
            <div style={{ color: C.text, fontSize: 15, fontWeight: 600 }}>Payment Method</div>
