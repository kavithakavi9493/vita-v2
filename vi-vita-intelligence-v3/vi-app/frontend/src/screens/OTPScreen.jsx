    ...
    try {
      ...
      await setDoc(
        userRef,
        {
          ...
          currentStreak:
            userSnap.data()?.currentStreak || 0,

          bestStreak:
            userSnap.data()?.bestStreak || 0,

          lastLogDate:
            userSnap.data()?.lastLogDate || null,
      ...
      update({
        ...
        userId: uid,
        isLoggedIn: true,
        hasCompletedQuiz: respSnap.exists()
      })
